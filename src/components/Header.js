  ...
  render () {
    ...
    var typefaceList = _map(Object.keys(data.fonts), function (index) {
      ...
      if (font.published !== false && font.designer) {
        return (
          <li className="col-12 sm-col-6 md-col-4 px2 m0" key={ 'footer_' + index }><a className="block py2 border-none" href={ '#' + index }>
            <div className="flex items-center">
              <div className="h1 col-4 sm-col-3 md-col-6 right-align pr2 maroon">
